...
extension ImageProcessing {
    public func process(image: PlatformImage) -> PlatformImage? {
        return process(image: image, context: nil)
    }
}
...
extension ImageProcessor {
    ...
    public struct Resize: ImageProcessing, Hashable, CustomStringConvertible {
        ...
        public func process(image: PlatformImage, context _: ImageProcessingContext?) -> PlatformImage? {
    ...
    extension ImageProcessor {
        ...
        public struct Circle: ImageProcessing, Hashable, CustomStringConvertible {
            ...
            public func process(image: UIImage, context _: ImageProcessingContext?) -> UIImage? {
...
// MARK: - CoreGraphics Helpers (Internal)
    ...
    extension NSImage {
        ...
        static func make(cgImage: CGImage, source _: NSImage) -> NSImage {
