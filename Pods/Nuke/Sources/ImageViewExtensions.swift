...
private final class ImageViewController {
    ...
    // MARK: - Handling Responses
        ...
        private func handle(result: Result<ImageResponse, ImagePipeline.Error>, fromMemCache _: Bool, options: ImageLoadingOptions) {
            switch result {
            case let .success(response):
        ...
        private func handle(partialImage response: ImageResponse, options _: ImageLoadingOptions) {
            imageView?.nuke_display(image: response.image)
        }
